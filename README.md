...
На схеме любого типа можно щёлкнуть правой кнопкой мыши и выбрать
**«Создать метку»**. Метку можно перетаскивать мышью, открыть двойным щелчком
для редактирования либо через контекстное меню клонировать и удалить.
Произвольные метки сохраняются вместе с документом и не смешиваются со
встроенными обозначениями сил, размеров и узлов.
