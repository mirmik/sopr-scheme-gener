...
Размер листа задаётся независимо от областей задачи и общей подписи. При
наведении на одну из областей появляется синяя рамка: прямоугольный grip
перемещает её, а маркеры на сторонах и углах изменяют размер. Внутренняя
область остаётся доступна для элементов управления самой задачи. Служебные
рамки в экспорт не попадают.
